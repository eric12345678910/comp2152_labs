...
#monster_power_keys = ["Fire Magic", "Freeze Time", "Super Hearing"])
...
#Q8: Use First Loot Item
use_item = belt.pop(0)
if use_item in good_loot_options:
    health_points = min(6, health_points + 2) #return lower of two numbers
elif use_item in bad_loot_options:
    health_points = max(0, health_points - 2) #return higher of two numbers
else:
    print("Not helpful")
